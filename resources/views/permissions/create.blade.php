        ...
        <div class="pt-5">
            <div class="panel">
                <div class="flex items-center justify-between mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">إضافة صلاحية جديدة</h5>
                </div>
                ...
                <form action="{{ route('permissions.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="display_name" type="text" name="display_name" class="form-input" value="{{ old('display_name') }}" required />
                        <p class="text-xs text-gray-500 mt-1">مثال: إنشاء مستخدم، تعديل مستخدم، حذف مستخدم</p>
                    </div>
                    <div>
                        <label for="group">المجموعة</label>
                        <input id="group" type="text" name="group" class="form-input" value="{{ old('group') }}" required />
