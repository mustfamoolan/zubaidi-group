        ...
        <div class="pt-5">
            <div class="panel">
                <div class="flex items-center justify-between mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">إضافة مستفيد جديد</h5>
                </div>
                ...
                <form action="{{ route('companies.beneficiaries.store', $company) }}" method="POST" class="space-y-5">
                    @csrf
                    <div>
                        <label for="name">اسم المستفيد</label>
                        <input id="name" name="name" type="text" value="{{ old('name') }}" class="form-input" placeholder="أدخل اسم المستفيد" required />
                        @error('name')
