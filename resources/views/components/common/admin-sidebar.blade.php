            ...
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/logo.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">مجموعة الزبيدي</span>
                </a>
                <a href="javascript:;"
                        ...
                        <button type="submit" class="nav-link group w-full text-right">
                            <div class="flex items-center">
                                <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.5"
                                        d="M8.90002 2L15.1 2C16.6802 2 17.4702 2 18.0602 2.32698C18.5765 2.6146 18.9854 3.02354 19.273 3.53984C19.6 4.12984 19.6 4.91984 19.6 6.5L19.6 17.5C19.6 19.0802 19.6 19.8702 19.273 20.4602C18.9854 20.9765 18.5765 21.3854 18.0602 21.673C17.4702 22 16.6802 22 15.1 22H8.90002C7.31984 22 6.52984 22 5.93984 21.673C5.42354 21.3854 5.0146 20.9765 4.72698 20.4602C4.4 19.8702 4.4 19.0802 4.4 17.5L4.4 6.5C4.4 4.91984 4.4 4.12984 4.72698 3.53984C5.0146 3.02354 5.42354 2.6146 5.93984 2.32698C6.52984 2 7.31984 2 8.90002 2Z"
                                        fill="currentColor" />
                                    <path
                                        d="M9 8.5C9 8.22386 9.22386 8 9.5 8H14.5C14.7761 8 15 8.22386 15 8.5C15 8.77614 14.7761 9 14.5 9H9.5C9.22386 9 9 8.77614 9 8.5Z"
                                        fill="currentColor" />
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path
                                        d="M9 14.5C9 14.2239 9.22386 14 9.5 14H14.5C14.7761 14 15 14.2239 15 14.5C15 14.7761 14.7761 15 14.5 15H9.5C9.22386 15 9 14.7761 9 14.5Z"
                                        fill="currentColor" />
                                </svg>
                                <span
