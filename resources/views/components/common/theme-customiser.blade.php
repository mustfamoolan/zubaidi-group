    ...
    <nav class="bg-white fixed ltr:-right-[400px] rtl:-left-[400px] top-0 bottom-0 w-full max-w-[400px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] dark:bg-[#0e1726] p-4"
        ...
        <div class="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
            <div class="text-center relative pb-5">
                ...
                <h4 class="mb-1 dark:text-white">إعدادات المظهر</h4>
                <p class="text-white-dark">اختر التفضيلات التي تريدها للقالب</p>
            </div>
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">نظام الألوان</h5>
                <p class="text-white-dark text-xs">اختر بين الوضع الفاتح أو الداكن</p>
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">موقع القائمة</h5>
                <p class="text-white-dark text-xs">اختر نوع القائمة الرئيسية للتطبيق</p>
                <div class="grid grid-cols-3 gap-2 mt-3">
                    <button type="button" class="btn"
                ...
                <div class="mt-5 text-primary">
                    <label class="inline-flex mb-0">
                        ...
                        <span>شبه داكن (القائمة والرأس)</span>
                    </label>
                </div>
            </div>
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">نمط التخطيط</h5>
                <p class="text-white-dark text-xs">اختر التخطيط الأساسي للتطبيق</p>
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">الاتجاه</h5>
                <p class="text-white-dark text-xs">اختر اتجاه النصوص في التطبيق</p>
                <div class="flex gap-2 mt-3">
                    <button type="button" class="btn flex-auto"
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">نوع شريط التنقل</h5>
                <p class="text-white-dark text-xs">ثابت أو عائم</p>
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">حركة الانتقال</h5>
                <p class="text-white-dark text-xs">تأثير حركة المحتوى الرئيسي</p>
                <div class="mt-3">
