                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">أدخل البريد الإلكتروني وكلمة المرور للدخول</p>
                        </div>
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="email" name="email" type="email" value="{{ old('email') }}" placeholder="أدخل البريد الإلكتروني" class="form-input ps-10 placeholder:text-white-dark" required />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="password" name="password" type="password" placeholder="أدخل كلمة المرور" class="form-input ps-10 placeholder:text-white-dark" required />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input type="checkbox" name="remember" class="form-checkbox bg-white dark:bg-black" {{ old('remember') ? 'checked' : '' }} />
                                    <span class="text-white-dark">تذكرني</span>
                                </label>
                            </div>
                            <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">تسجيل الدخول</button>
                        </form>
                    </div>
                </div>
            </div>
