    ...
    <div class="panel">
        ...
        <form action="{{ route('companies.invoices.update', [$company, $invoice]) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <div class="flex">
                    <input id="amount_usd" name="amount_usd" type="text" step="0.01" value="{{ old('amount_usd', $invoice->amount_usd) }}" class="form-input rounded-none number-input" required oninput="calculateTotalAmount()" />
            ...
            <div class="mb-5">
                ...
                <div class="flex">
                    <input id="exchange_rate" name="exchange_rate" type="text" step="0.01" value="{{ old('exchange_rate', $invoice->exchange_rate) }}" class="form-input rounded-none number-input" required oninput="calculateTotalAmount()" />
            ...
            <div class="mb-5">
                ...
                <div class="flex">
                    <input id="bank_commission_percent" name="bank_commission_percent" type="text" step="0.01" min="0" max="100" placeholder="0.00" class="form-input rounded-none number-input" value="{{ old('bank_commission_percent', $commissionPercent) }}" oninput="calculateTotalAmount()" />
