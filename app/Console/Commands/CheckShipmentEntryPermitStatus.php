...
class CheckShipmentEntryPermitStatus extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'shipments:check-entry-permit';
     ...
     * @var string
     */
    protected $description = 'التحقق من الشحنات التي مر عليها 30 يوم وإنشاء تنبيه لحالة تصريح الدخول';
    ...
    {
        $this->info('بدء التحقق من حالة تصريح الدخول للشحنات...');

        // الحصول على الشحنات التي مر عليها 30 يوم بالضبط وحالة تصريح الدخول غير محدثة
        ...
        foreach ($shipments as $shipment) {
            ...
            foreach ($users as $user) {
                ...
                $notification = Notification::create([
                    ...
                    'message' => "تنبيه: مر 30 يوم على شحن الحاوية {$shipment->container_number}. يرجى تحديث حالة تصريح الدخول.",
                ]);
